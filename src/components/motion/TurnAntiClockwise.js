...
const TurnAntiClockWise = ({ character, characterAngle, comp_id }) => {
  ...
  return (
    <Paper elevation={3}>
      <div className="text-center rounded bg-blue-100 border border-blue-400 py-2 my-2 text-xs cursor-pointer">
        ...
        <div
          id={comp_id}
          className={`flex bg-blue-400 my-2 mx-6 rounded text-xs cursor-pointer text-center`}
          onClick={() => handleClick()}
        >
